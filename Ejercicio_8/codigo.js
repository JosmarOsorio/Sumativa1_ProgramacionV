...
"x === y" la cual resulta ser falsa ya que la variable "x" no es estrictamente igual a la variable "y". Teniendo esto en cuenta vemos que la expresion completa del lado derecho
...
expresion es verdadera. Entonces podemos dceir que !( x == "15" || x === y ) es verdadera.

Por otro lado haciendo al revision del alod drecho de la expresion tenemos "y !== 2" esto comapara que la vairbale "y" sea diferente a 2 lo cual es falso ya que "y = 2".
...
Por ultimos podemos decir que la expresion completa es verdadera debidio a que ambas comparativas dan como resultado verdadero en su analisis.*/